#!/usr/bin/env julia
# scripts/wind_sweep_triangle3_90s_induction.jl — INDUCTION ON variant — triangle3 wind sweep RE-RUN at 90 s MPPT.
#
...
const OUT_CSV = joinpath(@__DIR__, "results", "control_maps", "wind_sweep_triangle3_90s_induction.csv")
...
if !isfile(OUT_CSV)
    open(OUT_CSV, "w") do io
        println(io, "# wind_sweep_triangle3_90s_induction.csv — deliberate triangle3 (build_phantom_triangle), 90 s MPPT re-run")
