...
open(joinpath(OUT_DIR, "PROVENANCE.md"), "w") do io
    ...
    println(io, "- **ObjectiveConfig:** tail5, penalize_ceiling=false, fos_target=2.5, fos_hard=2.5,")
    println(io, "  kickstart 0.0, k_mppt = K_MPPT_5KW_HONEST (2.24) — NOT p.k_mppt (3.55).")
