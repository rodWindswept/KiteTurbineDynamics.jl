...
function build_smoke_grid()
    [
        (wind_speed=6.0,  payout_duration=4.0,  active_winch=false, damping_mode=0.0, EA_back_line=350000.0, c_back_line=250.0, i_pto=12.5, field_imu=true, mppt_stall=false, payout_base_m=15.0, lifter_elev_deg=75.0, duration_s=10.0),
        (wind_speed=15.0, payout_duration=4.0,  active_winch=true,  damping_mode=2.0, EA_back_line=700000.0, c_back_line=500.0, i_pto=25.0, field_imu=true, mppt_stall=false, payout_base_m=15.0, lifter_elev_deg=75.0, duration_s=10.0),
        (wind_speed=20.0, payout_duration=15.0, active_winch=true,  damping_mode=2.0, EA_back_line=700000.0, c_back_line=500.0, i_pto=25.0, field_imu=true, mppt_stall=false, payout_base_m=15.0, lifter_elev_deg=75.0, duration_s=10.0),
    ]
end
...
function main()
    ...
    @info @sprintf("Campaign V3 complete: %d runs in %.1f minutes", n_runs, elapsed_total / 60)
