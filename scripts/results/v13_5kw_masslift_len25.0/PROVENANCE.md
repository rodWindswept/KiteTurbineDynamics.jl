# PROVENANCE — v13_5kw_masslift_len25.0
...
- **Baseline (fixed-rotary regime):** scripts/results/v13_5kw_len25.0/
...
- **Identical to first campaign:** seeds (seed_genome(5.0)), RNG (Random.seed!(42+island-1)),
  ...
  kickstart 0, k_mppt = p.k_mppt), length 25.0 m, DE sizing 10×3×30.
