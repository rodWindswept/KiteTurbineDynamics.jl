# PROVENANCE — v13_5kw_masslift_len21.2
...
- **Baseline (fixed-rotary regime):** scripts/results/v13_5kw_len21.2/
...
- **Identical to first campaign:** seeds (seed_genome(5.0)), RNG (Random.seed!(42+island-1)),
  ...
  kickstart 0, k_mppt = p.k_mppt), length 21.2 m, DE sizing 10×3×30.
