...
| x4 | Do_scale_exp | 0.0 | 1.0 | — | `design_from_vector_v4` | How fast tube diameter tapers from hub toward ground. 0 = no taper. | DE can un-taper to save mass at ground ring |
