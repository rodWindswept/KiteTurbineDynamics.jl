...
The term "Furl" is now strictly reserved for future work on the *lift device itself* (i.e. aerodynamic furling of the top lifting kite under extreme winds). The wind-spilling maneuver for the main TRPT generating rotor is now named **"Pitch Depower"**.
...
1.  **Makie Toggle Attribute Bug Resolved:**
    *   **Issue:** The Toggle constructors at lines 1350 and 1360 used `buttoncolor_active`, which is not a valid Makie Toggle attribute.
