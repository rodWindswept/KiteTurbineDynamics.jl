...
11. Tveide, T. *TetherDragODESolver*. GitHub repository. Validates the ¼ tether drag coefficient for conventional AWE; confirms TRPT drag scaling.
12. Read, R. (2013). Multi-kite architecture concepts. Presentation, Berlin.
13. Read, R. (2015). Daisy Kite: a tested rotary AWE model. Airborne Wind Energy Conference, Delft.
