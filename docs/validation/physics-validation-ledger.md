...
| E7 | **"6.76 kg 5 kW winner" (completed 2026-08-22 campaign)** | blade mass priced 2.13·λ³ while span = 0.75·r_rotor·λ (r_rotor BEM-sized): spans 1.24-1.71 m priced at 0.26-0.70 kg vs the span³ truth 0.80-2.10 kg (~3.0× under; the volume error span³/λ³ ≈ 15.4× was masked 5.08× by the baked-in rung reference). Winners VOID; campaign re-runs on the span³ law (DECISIONS [2026-08-22]) |
