...
- [Topology document integrity](wayfinder-tickets/dc1-topology-doc-integrity.md): every rotor takes an equal share of the torque and the power requirement. The lowest rotor sits in the slower wind profile and carries the column above it. Every rotor above the lowest takes the co-axial wake de-rate, set at 0.75x freestream power. The retracted thrust split leaves the checklist. One figure stays open: the recalled 15 per cent against the recorded 75 per cent.
